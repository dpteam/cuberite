...
private:
	...
	static void WINAPI serviceMain(DWORD argc, TCHAR *argv[])
	{
		...
		if (GetModuleFileName(nullptr, applicationFilename, ARRAYCOUNT(applicationFilename)) == 0)
		{
		...
		if (wcstombs(MultibyteArgV0, argv[0], sizeof(MultibyteArgV0)) == static_cast<size_t>(-1))
		{
			MultibyteArgV0[0] = '\0';
		}
